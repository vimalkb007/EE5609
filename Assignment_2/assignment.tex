...
We get the values of $\lambda_1$ = $\frac{29}{21}$ and $\lambda_2$ = $\frac{-26}{21}$. Checking if these values satisfy the equation $\ref{eq13}$.

\begin{align}
	-3\left(\frac{29}{21}\right)  - 4\left(\frac{-26}{21}\right) = \frac{17}{21} \\
	\implies \frac{17}{21} \neq 8
\end{align}
...
The above symmetric equations \ref{eq14}, \ref{eq15} can be represented in the vector form as 
